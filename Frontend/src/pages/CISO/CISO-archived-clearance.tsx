...
export default function CISOArchiveClearance() {
  ...
  const loadTimelines = React.useCallback(() => {
    setLoading(true);
    return fetch("/admin/xu-faculty-clearance/api/ciso/archived-clearance")
            ...
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbLink asChild>
                  <Link to="/system-admin-archived-clearance" onClick={() => setSelectedTimeline(null)}>View Clearance Records</Link>
                </BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
