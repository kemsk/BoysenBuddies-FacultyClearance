...
export default function AssistantApproverArchivedIndividualApproval() {
  ...
  React.useEffect(() => {
    ...
    fetch(`/admin/xu-faculty-clearance/api/assistant-approver/archived-individual?timelineId=${encodeURIComponent(timelineId)}&archivedId=${encodeURIComponent(archivedId)}`, {
      credentials: "include",
    })
      .then(async (res) => {
