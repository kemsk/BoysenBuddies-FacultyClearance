...
export default function Facultydashboard() {
  ...
  const fullName = profile
    ? [profile.faculty.firstName, profile.faculty.middleName, profile.faculty.lastName]
        .filter(Boolean)
        .join(" ")
  ...
  const facultyTypeLabel = profile?.faculty.facultyType ?? "Full-time Faculty (On Probation)";
