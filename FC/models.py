...
class ActivityLog(models.Model):
    ...
    class EventType(models.TextChoices):
        ...
        DELETED_GUIDELINE = "deleted_guideline", "deleted_guideline"
    ...
    role_value = models.IntegerField(null=True, blank=True)
    ...
    # Admin field (renamed from actor_admin_id)
