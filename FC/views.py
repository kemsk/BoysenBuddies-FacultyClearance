...
def google_oauth_callback(request):
    ...
    if intended_role == "ovphe":
        ...
        try:
            ...
            role_name = get_role_name_for_value(role_value) if role_value is not None else "OVPHE"
            ...
            ActivityLog.objects.create(
                ...
                user_role=str(role_name) if role_name is not None else None,
    ...
    if intended_role == "ciso":
        ...
        try:
            ...
            role_name = get_role_name_for_value(role_value) if role_value is not None else "CISO"
...
def _admin_user(admin):
    ...
    return getattr(admin, "user", admin)
...
def ovphe_activity_logs_api(request):
    ...
    if request.method == "POST":
        ...
        obj = ActivityLog.objects.create(
            ...
            is_superadmin=bool(getattr(admin_user, "is_superuser", False)) if admin_user else False,



            is_staff=bool(getattr(admin_user, "is_staff", False)) if admin_user else False,
...
def ciso_notifications_api(request):
    ...
    admin_user = getattr(admin, "user", admin)
    ...
    qs = Notification.objects.filter(user=admin_user).order_by("-created_at", "-id")
...
def ciso_activity_logs_api(request):
    ...
    if request.method == "POST":
        ...
        obj = ActivityLog.objects.create(
            ...
            is_superadmin=bool(getattr(admin_user, "is_superuser", False)),



            is_staff=bool(getattr(admin_user, "is_staff", False)),
...
def approver_activity_logs_api(request):
    ...
    qs = ActivityLog.objects.select_related("user", "faculty", "requirement").filter(
        models.Q(user_role__istartswith="Approver") | models.Q(user_role__istartswith="Assistant")
    )
