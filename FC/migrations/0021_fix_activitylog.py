# Generated migration to fix activity log issues
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('FC', '0020_add_activitylog_columns'),
    ]

    operations = [
        # Update event_type field with new choices (skip supervisor field as it already exists)
